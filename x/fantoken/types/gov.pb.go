...
// source: incubus/fantoken/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UpdateFeesProposal)(nil), "incubus.fantoken.v1beta1.UpdateFeesProposal")
	proto.RegisterType((*UpdateFeesProposalWithDeposit)(nil), "incubus.fantoken.v1beta1.UpdateFeesProposalWithDeposit")
}

func init() {
	proto.RegisterFile("incubus/fantoken/v1beta1/gov.proto", fileDescriptor_1525a26433a8d1c3)
}
