...
// source: incubus/fantoken/v1beta1/fantoken.proto
...
func init() {
	proto.RegisterType((*Metadata)(nil), "incubus.fantoken.v1beta1.Metadata")
	proto.RegisterType((*FanToken)(nil), "incubus.fantoken.v1beta1.FanToken")
}

func init() {
	proto.RegisterFile("incubus/fantoken/v1beta1/fantoken.proto", fileDescriptor_af4dfaf3dfee0855)
}
