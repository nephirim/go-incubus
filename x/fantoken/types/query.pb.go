...
// source: incubus/fantoken/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryFanTokenRequest)(nil), "incubus.fantoken.v1beta1.QueryFanTokenRequest")
	proto.RegisterType((*QueryFanTokenResponse)(nil), "incubus.fantoken.v1beta1.QueryFanTokenResponse")
	proto.RegisterType((*QueryFanTokensRequest)(nil), "incubus.fantoken.v1beta1.QueryFanTokensRequest")
	proto.RegisterType((*QueryFanTokensResponse)(nil), "incubus.fantoken.v1beta1.QueryFanTokensResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "incubus.fantoken.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "incubus.fantoken.v1beta1.QueryParamsResponse")
}

func init() {
	proto.RegisterFile("incubus/fantoken/v1beta1/query.proto", fileDescriptor_e961b51f12bacf3d)
}
...
func (c *queryClient) FanToken(ctx context.Context, in *QueryFanTokenRequest, opts ...grpc.CallOption) (*QueryFanTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/incubus.fantoken.v1beta1.Query/FanToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FanTokens(ctx context.Context, in *QueryFanTokensRequest, opts ...grpc.CallOption) (*QueryFanTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/incubus.fantoken.v1beta1.Query/FanTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/incubus.fantoken.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FanToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/incubus.fantoken.v1beta1.Query/FanToken",
	}
...
func _Query_FanTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/incubus.fantoken.v1beta1.Query/FanTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/incubus.fantoken.v1beta1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "incubus.fantoken.v1beta1.Query",
	...
	Metadata: "incubus/fantoken/v1beta1/query.proto",
}
