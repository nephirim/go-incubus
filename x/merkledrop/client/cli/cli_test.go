...
import (
	...
	"github.com/nephirim/go-incubus/x/merkledrop/client/cli"
...
func accountJson(t *testing.T, addr sdk.AccAddress) (string, map[string]cli.ClaimInfo, error) {
	list := fmt.Sprintf(`
		{
		  "%s": "100000",
		  "incubus1zm6wlhr622yr9d7hh4t70acdfg6c32kcv34duw": "200000",
		  "incubus1nzxmsks45e55d5edj4mcd08u8dycaxq5eplakw": "300000"
		}
		`, addr.String(),
	)
...
func TestSimpleProof(t *testing.T) {
	leafs := [][]byte{
		[]byte("0incubus1vgpsha4f8grmsqr6krfdxwpcf3x20h0q3ztaj21000000"),
		[]byte("1incubus1zm6wlhr622yr9d7hh4t70acdfg6c32kcv34duw2000000"),
		[]byte("2incubus1nzxmsks45e55d5edj4mcd08u8dycaxq5eplakw3000000"),
	}
...
func TestCreateProof(t *testing.T) {
	...
	accounts := map[string]string{
		"incubus1vgpsha4f8grmsqr6krfdxwpcf3x20h0q3ztaj2": "1000000",
