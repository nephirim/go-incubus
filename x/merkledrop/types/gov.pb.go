...
// source: incubus/merkledrop/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UpdateFeesProposal)(nil), "incubus.merkledrop.v1beta1.UpdateFeesProposal")
	proto.RegisterType((*UpdateFeesProposalWithDeposit)(nil), "incubus.merkledrop.v1beta1.UpdateFeesProposalWithDeposit")
}

func init() {
	proto.RegisterFile("incubus/merkledrop/v1beta1/gov.proto", fileDescriptor_12c02fad8b811074)
}
