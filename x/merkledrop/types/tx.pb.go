...
// source: incubus/merkledrop/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreate)(nil), "incubus.merkledrop.v1beta1.MsgCreate")
	proto.RegisterType((*MsgCreateResponse)(nil), "incubus.merkledrop.v1beta1.MsgCreateResponse")
	proto.RegisterType((*MsgClaim)(nil), "incubus.merkledrop.v1beta1.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "incubus.merkledrop.v1beta1.MsgClaimResponse")
}

func init() {
	proto.RegisterFile("incubus/merkledrop/v1beta1/tx.proto", fileDescriptor_1a7f318739b2d6d2)
}
...
func (c *msgClient) Create(ctx context.Context, in *MsgCreate, opts ...grpc.CallOption) (*MsgCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/incubus.merkledrop.v1beta1.Msg/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/incubus.merkledrop.v1beta1.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/incubus.merkledrop.v1beta1.Msg/Create",
	}
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/incubus.merkledrop.v1beta1.Msg/Claim",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "incubus.merkledrop.v1beta1.Msg",
	...
	Metadata: "incubus/merkledrop/v1beta1/tx.proto",
}
