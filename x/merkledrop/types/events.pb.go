...
// source: incubus/merkledrop/v1beta1/events.proto
...
func init() {
	proto.RegisterType((*EventCreate)(nil), "incubus.merkledrop.v1beta1.EventCreate")
	proto.RegisterType((*EventClaim)(nil), "incubus.merkledrop.v1beta1.EventClaim")
	proto.RegisterType((*EventWithdraw)(nil), "incubus.merkledrop.v1beta1.EventWithdraw")
}

func init() {
	proto.RegisterFile("incubus/merkledrop/v1beta1/events.proto", fileDescriptor_3042ab6a9db80a59)
}
