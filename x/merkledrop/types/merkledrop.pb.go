...
// source: incubus/merkledrop/v1beta1/merkledrop.proto
...
func init() {
	proto.RegisterType((*Merkledrop)(nil), "incubus.merkledrop.v1beta1.Merkledrop")
}

func init() {
	proto.RegisterFile("incubus/merkledrop/v1beta1/merkledrop.proto", fileDescriptor_21aba39fc2313837)
}
