...
import (
	"fmt"
	v013 "github.com/nephirim/go-incubus/app/upgrades/v013"
	v014 "github.com/nephirim/go-incubus/app/upgrades/v014"
	"strings"

	v010 "github.com/nephirim/go-incubus/app/upgrades/v010"
	v011 "github.com/nephirim/go-incubus/app/upgrades/v011"
	"github.com/nephirim/go-incubus/x/fantoken"
	fantokenkeeper "github.com/nephirim/go-incubus/x/fantoken/keeper"
	fantokentypes "github.com/nephirim/go-incubus/x/fantoken/types"
	"github.com/nephirim/go-incubus/x/merkledrop"
	merkledropkeeper "github.com/nephirim/go-incubus/x/merkledrop/keeper"
	merkledroptypes "github.com/nephirim/go-incubus/x/merkledrop/types"
	...
	appparams "github.com/nephirim/go-incubus/app/params"
	fantokenclient "github.com/nephirim/go-incubus/x/fantoken/client"
	merkledropclient "github.com/nephirim/go-incubus/x/merkledrop/client"
	...
	_ "github.com/nephirim/go-incubus/swagger/statik"
)

const appName = "IncubusApp"
...
var (
	_ CosmosApp               = (*IncubusApp)(nil)
	_ servertypes.Application = (*IncubusApp)(nil)
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".incubusd")
}

// IncubusApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type IncubusApp struct {
	*baseapp.BaseApp
...
// NewIncubusApp returns a reference to an initialized IncubusApp.
func NewIncubusApp(
...
func (app *IncubusApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *IncubusApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *IncubusApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *IncubusApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *IncubusApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *IncubusApp) ModuleAccountAddrs() map[string]bool {
...
func (app *IncubusApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *IncubusApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Gaia's InterfaceRegistry
func (app *IncubusApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *IncubusApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *IncubusApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *IncubusApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *IncubusApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *IncubusApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *IncubusApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *IncubusApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *IncubusApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

func (app *IncubusApp) setupUpgradeStoreLoaders() {
...
func (app *IncubusApp) setupUpgradeHandlers() {
